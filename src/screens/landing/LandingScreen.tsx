...
export function LandingScreen({ navigation }: any) {
  ...
  const landingGradient = useMemo(
    () => [colors.landingBg, colors.landingSurface, colors.landingBg] as const,
    [colors]
  );
  const s = useMemo(
    () =>
      StyleSheet.create({
        background: { flex: 1, width: SCREEN_WIDTH, height: SCREEN_HEIGHT },
        bgImage: { ...StyleSheet.absoluteFillObject, opacity: 0.5 },
        overlay: {
          ...StyleSheet.absoluteFillObject,
          backgroundColor: mode === "dark" ? "rgba(15,23,42,0.25)" : "rgba(15,23,42,0.15)"
        },
        logoContainer: {
        ...
        logoCard: {
          backgroundColor: mode === "dark" ? "rgba(255,255,255,0.06)" : "rgba(255,255,255,0.12)",
          borderRadius: 20,
          paddingVertical: 24,
        ...
        label: {
          fontSize: 13,
          fontWeight: "600",
          color: colors.landingTextMuted,
          letterSpacing: 1.2,
          textTransform: "uppercase",
          marginBottom: 12
        },
        headlineBlock: { minHeight: 52, justifyContent: "center", marginBottom: 12 },
        headline: {
          fontSize: 24,
          fontWeight: "700",
          color: colors.landingText,
        ...
        dividerLine: {
          flex: 1,
          height: 1,
          backgroundColor: colors.landingTextMuted + "40"
        },
        dividerText: {
          fontSize: 13,
          color: colors.landingTextMuted,
        ...
        secondaryBtn: { paddingVertical: 14, paddingHorizontal: 24 },
        secondaryBtnText: {
          fontSize: 16,
          color: colors.landingText,
          fontWeight: "600"
  ...
  return (
    <View style={s.background}>
      <LinearGradient colors={landingGradient} style={StyleSheet.absoluteFill} />
      ...
      <View style={[s.contentCenter, { paddingBottom: insets.bottom + 100 }]}>
        <View style={s.content}>
          ...
          <View style={s.headlineBlock}>
            {loading ? (
              <ActivityIndicator size="small" color={colors.landingText} />
            ) : (
